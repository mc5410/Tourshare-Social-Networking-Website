...
public partial class USER_POST : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            conn = new MySql.Data.MySqlClient.MySqlConnection();
            conn.ConnectionString = myConnectionString;
            MySqlDataAdapter da = new MySqlDataAdapter("select distinct location from location", conn);
            DataSet ds = new DataSet();
            da.Fill(ds, "circles");
            int a = ds.Tables[0].Rows.Count;
            string[] b = new string[100];
    ...
    protected void btnbook_Click(object sender, EventArgs e)
    {
        ...
        if (TXTBID.Text == "")
        {
            MessageBox.Show("Share your thoughts");
        }else{

            int str = con.post(formatForMySql, DropDownList2.Text, TXTBID.Text, uname.Text , DropDownList1.Text);
